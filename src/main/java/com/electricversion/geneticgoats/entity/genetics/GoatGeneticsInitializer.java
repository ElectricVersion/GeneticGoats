...
public class GoatGeneticsInitializer extends AbstractGeneticsInitialiser {
    ...
    public static final int AUTOSOMAL_GENES_LENGTH = 166;
    ...
    protected Genes generateLocalWildGenetics(Holder<Biome> biomeHolder, boolean b) {
        ...
        /* FERTILITY
         * 1 - Low (1 - 2 kids); Incomplete Dominant
         * 2 - Medium (2 - 3 kids); Incomplete Dominant
         * 3 - High (3 - 4 kids); Incomplete Dominant
         */
        autosomalGenes[160] = randomizeGene(3);
        autosomalGenes[161] = randomizeGene(3);

        /* MYOTONIA/CLCN1
         * 1 - Non-fainting (wildtype); Dominant
         * 2 - Fainting/myotonic; Recessive
         */
        autosomalGenes[162] = randomizeGene(2);
        autosomalGenes[163] = randomizeGene(2);

        /* SOCK WEIGHTING
         * 1 - Front-heavy (wildtype); Dominant
         * 2 - Back-heavy; Incomplete Dom
         * 3 - Even; Recessive
         *
         */
        autosomalGenes[164] = randomizeGene(2);
        autosomalGenes[165] = randomizeGene(2);
